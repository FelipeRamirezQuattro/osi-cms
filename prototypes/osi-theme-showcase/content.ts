...
export const themes: Array<{
...
}> = [
  {
    ...
    characteristics: "Full-bleed operational imagery, deep navy surfaces, oversized condensed type, controlled OSI gold, and weighty proof points.",
    palette: ["#001B33", "#F2E9DE", "#E2902A", "#234E7B"],
  ...
  },
  {
    ...
    characteristics: "Split layouts, technical grids, cropped equipment imagery, coordinate marks, OSI steel, and signal gold.",
    palette: ["#001B33", "#F2E9DE", "#E2902A", "#234E7B"],
  ...
  },
  {
    ...
    characteristics: "Generous whitespace, OSI navy and cream, warm sand, atmospheric imagery, and contour-inspired curves.",
    palette: ["#001B33", "#F2E9DE", "#E2902A", "#234E7B"],
  ...
  },
  {
    ...
    characteristics: "Worker-led compositions, work-order labels, OSI navy, cream, signal gold, and compact utility typography.",
    palette: ["#001B33", "#F2E9DE", "#E2902A", "#234E7B"],
  ...
  },
  {
    ...
    characteristics: "Restrained editorial splits, modular cards, OSI cream and navy, and a controlled signal-gold accent.",
    palette: ["#001B33", "#F2E9DE", "#E2902A", "#234E7B"],
