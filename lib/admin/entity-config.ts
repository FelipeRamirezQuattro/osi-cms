...
export const ENTITY_CONFIGS: Record<EntityKey, EntityConfig> = {
  ...
  news: {
    table: "news_posts",
    label: "News or blog post",
    pluralLabel: "News & blog",
    hasPosition: false,
    hasStatus: true,
    allowArchive: true,
    listColumns: [
    ...
    fields: [
      ...
      { key: "slug", label: "Slug", type: "text" },
      { key: "kind", label: "Kind", type: "select", options: ["news", "conference", "event", "blog"] },
      ...
      { key: "author_name", label: "Author (blog)", type: "text", optional: true },
      { key: "tags", label: "Tags (blog)", type: "array", optional: true, maxItems: 10 },
      { key: "reading_minutes", label: "Reading time, minutes (blog)", type: "number", optional: true },
    ...
    defaults: { title: "", slug: "", locale: "en", kind: "news", status: "draft", is_featured: false, tags: [] },
  },
  resources: {
    table: "resources",
    label: "Resource",
